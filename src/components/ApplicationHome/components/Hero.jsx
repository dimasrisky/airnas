...
const Hero = () => {
  return (
    <section className="flex flex-col items-center justify-center gap-[10px] overflow-hidden px-[4%] py-[50%] sm:px-[10%] sm:py-[5%] lg:mx-auto lg:flex lg:min-h-screen lg:max-w-[650px] lg:items-center lg:justify-center lg:px-0 lg:py-0">
