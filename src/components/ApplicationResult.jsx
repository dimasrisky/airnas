        ...
        <div className="weather-bg h-[498px] w-full max-w-[915px] rounded-[30px] sm:h-[683px] lg:h-[480px]">
          <div className="flex h-full w-full flex-col items-center gap-[10px] py-[30px] lg:flex-row lg:justify-center lg:gap-[100px] px-[25px] sm:px-[100px]">
            <div className="flex flex-col justify-center text-center">
              ...
              <h3 className="textShadow mb-[5px] text-[12px] font-bold text-white sm:text-[16px] ">{`${state || "Loading"}, ${country || "Loading"}`}</h3>
              <p className="textShadow text-[12px] font-normal text-white sm:text-[16px] ">{date || "Loading"}</p>
              <img src={weatherIcon(ic)} alt="icon" className="mx-auto -mt-[25px] h-[170px] w-[170px] sm:-mt-[10px] sm:h-[220px] sm:w-[220px]"/>
