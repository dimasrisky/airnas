...
const DataFactorCard = ({ icon, title, description, bigger, className }) => {
  return (
    <div
      className={`flex ${
        bigger ? `scale-100 xl:scale-110` : null
      } ${className} max-h-fit max-w-[274px] flex-col items-center justify-center gap-2 rounded-[0.3rem] bg-[#FCF5F4] px-8 py-6 sm:h-[324px]`}
    >
      <img
