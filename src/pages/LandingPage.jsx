    ...
    <>
        ...
        <div className="w-[100vw] border-b-2 bg-white py-[0.6rem] shadow-md">
          <div className="mx-auto flex w-[85%] items-center justify-between">
            ...
            <div className="hidden items-center gap-3 xl:flex">
              ...
              <Link to="/weather-home" className="bg-primary-500 btn-shadow ml-[1.5rem] rounded-md px-4 py-2 text-[0.7rem] text-white">Coba Airnas</Link>
            </div>
      ...
      <main className="mx-auto mt-[6rem] flex w-[85%] flex-col gap-[1rem] text-center xl:mt-[8rem] xl:flex-row-reverse xl:items-center xl:justify-between">
        ...
        <div className="flex flex-col gap-3 xl:w-[50%]">
          <div className="text-primary-600 bg-primary-100 mx-auto w-[15rem] rounded-full py-[0.1rem] text-[0.7rem] font-semibold xl:mx-0">Bencana Alam yang Tak Bisa Diabaikan</div>
          <h1 className="text-primary-900 text-[1.4rem] font-extrabold sm:text-[2.2rem] xl:text-left xl:text-[1.8rem]">Suhu Ekstrem, Ancaman <br /> Nyata{" "}<span className="text-primary-600">Bagi Kehidupan</span> <br />{" "}Makhluk Hidup</h1>
          ...
          <Link to="/weather-home" className="bg-primary-500 mx-auto mt-[1rem] w-[7rem] rounded-md py-2 text-[0.7rem] font-bold uppercase text-white sm:w-[10rem] sm:text-[0.8rem] xl:mx-0">coba sekarang</Link>
        </div>
      </main>

      {/* Data Section */}
      <main className="bg-primary-100 mx-auto mt-[6rem] w-[85%] rounded-[1rem] py-[2rem] text-center" id="penyebab">
        <div className="scale-[125%]">
          <h4 className="text-primary-500 text-[0.7rem] font-semibold uppercase">penyebab cuaca ekstrem</h4>
          <h1 className="text-primary-900 text-[1.2rem] font-extrabold xl:text-[1.3rem]">Data Yang Didapatkan</h1>
          <h5 className="text-primary-800 text-[0.6rem] font-semibold">Faktor Penyebab Suhu Ekstrem di Indonesia</h5>
        </div>
      ...
      <main className="mx-auto mt-[6rem] w-[85%] xl:mx-0 xl:flex xl:justify-center">
        ...
        <div className="mt-[1rem] text-center sm:mt-[3rem] sm:scale-[] xl:mt-0 xl:text-left">
          <h3 className="text-primary-600 text-md font-semibold uppercase">statistik</h3>
          <h1 className="text-primary-900 mt-[0.5rem] text-[1.4rem] font-extrabold sm:text-[1.6rem]">Statistik Dampak Suhu <br /> Ekstrem di Indonesia</h1>
      ...
      {/* Overview Section */}
      <main className="bg-primary-100 relative mx-auto mt-[6rem] flex w-[85%] flex-col gap-5 rounded-[2rem] px-[1.7rem] pb-[2rem] pt-[4rem] xl:flex-row-reverse xl:items-center" id="ringkasan">
        <img src="/assets/icons/logo.png" alt="logo" className="absolute left-4 top-4 w-[2rem] sm:w-[2.5rem]"/>
        <img src="/assets/img/airnas-preview.png" alt="airnas-overview" />
        <div className="flex flex-col gap-3">
          <h1 className="text-primary-900 font-extrabold sm:text-[1.3rem]">Airnas - Pengecek Cuaca</h1>
          ...
          <Link to="/weather-home" className="bg-primary-500 mx-auto mt-[1rem] w-[7rem] rounded-md py-2 text-center text-[0.7rem] font-bold text-white sm:w-[9rem] xl:mx-0">Coba Sekarang</Link>
        </div>
      </main>

      {/* NEWS Section */}
      <main className="mx-auto mt-[6rem] flex w-[85%] flex-col gap-6 xl:gap-0" id="berita">
        <div className="text-center xl:text-left">
          <h4 className="text-primary-500 text-[0.9rem] font-semibold uppercase">lihat berita terbaru</h4>
          <h1 className="text-primary-900 text-[1.4rem] font-extrabold sm:text-[1.7rem] xl:text-[2rem]">Berita & Artikel Terbaru</h1>
        ...
        <div className="mt-[1rem] flex flex-col gap-[2rem] xl:mt-[2rem] xl:flex-row xl:justify-center xl:gap-[5rem]">
          <div className="mx-auto flex flex-col gap-[0.5rem] xl:mx-0 xl:w-[50%]">
            ...
            <a href="https://regional.kompas.com/read/2023/10/03/153430878/cuaca-panas-di-babel-capai-38-derajat-celsius-pekerja-disarankan-pakai?page=all" className=" text-primary-800 text-[1rem] font-semibold leading-5 sm:text-[1.1rem] sm:leading-6">
        ...
        <a href="https://www.kompas.com/tag/cuaca-ekstrem" className="bg-primary-500 btn-shadow mx-auto mt-[1rem] w-[8rem] rounded-[0.4rem] py-2 text-center text-[0.6rem] font-bold text-white xl:mt-[3rem]">Lihat Selengkapnya</a>
      </main>
      ...
      <footer className="bg-primary-500 mt-[6rem] w-[100vw] rounded-t-[2rem] text-white">
          ...
          <div className="mt-[3rem] flex w-full flex-col gap-[3rem] sm:flex-row">
            ...
            <div>
              <div className="flex items-center justify-between" onClick={() => setIsPerusahaanDropdownOpen((prev) => !prev)}>
                <h1 className="text-[0.8rem] font-bold uppercase">perusahaan</h1>
            ...
            <div>
              <div className="flex items-center justify-between" onClick={() => setIsSosialMediaOpen((prev) => !prev)}>
                <h1 className="text-[0.8rem] font-bold uppercase">Sosial Media</h1>
        ...
        <div className="bg-primary-500 border-primary-700 border-t py-3 text-center text-[0.6rem]">COPYRIGHT © 2023 — Airnas | Asta Arkananta <br /> SMKN 8 MALANG</div>
      </footer>
    </>
  );
};
